...
class BrandController extends GetxController {
  ...
  Future<bool> updateProfile(Map<String, dynamic> data) async {
    ...
    if (res.success) {
      ...
      if (data['company_name'] != null)
        storedUser['name'] = data['company_name'];
  ...
  Future<bool> createProgram(Map<String, dynamic> data) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to create program',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
  ...
  Future<bool> updateProgram(int programId, Map<String, dynamic> data) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to update program',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
  ...
  Future<bool> deleteProgram(int programId) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to delete program',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
    ...
    try {
      ...
      if (res.success && res.data != null) {
        ...
        if (refresh) {
          Get.snackbar(
            'Error',
            res.message ?? 'Failed to load announcements',
            snackPosition: SnackPosition.BOTTOM,
            backgroundColor: Colors.red.withValues(alpha: 0.8),
          );
        }
  ...
  Future<bool> createAnnouncement(Map<String, dynamic> data) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to post announcement',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
    ...
    try {
      ...
      if (res.success && res.data != null) {
        ...
        if (refresh) {
          Get.snackbar(
            'Error',
            res.message ?? 'Failed to load manuals',
            snackPosition: SnackPosition.BOTTOM,
            backgroundColor: Colors.red.withValues(alpha: 0.8),
          );
        }
  ...
  Future<bool> uploadManual(String title, String filePath) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to upload manual',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
  ...
  Future<bool> deleteManual(int id) async {
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to delete manual',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
    ...
    try {
      ...
      if (res.success && res.data != null) {
        ...
        if (refresh) {
          Get.snackbar(
            'Error',
            res.message ?? 'Failed to load products',
            snackPosition: SnackPosition.BOTTOM,
            backgroundColor: Colors.red.withValues(alpha: 0.8),
          );
        }
  ...
  Future<void> fetchInstallers({
    ...
    try {
      ...
      final res = await _service.getInstallers(
        city: city,
        skills: skills,
        region: region,
      );
      ...
      if (res.success && res.data != null) {
        ...
        Get.snackbar(
          'Error',
          res.message ?? 'Failed to load installers',
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Colors.red.withValues(alpha: 0.8),
        );
      }
  ...
  Future<void> fetchNotifications() async {
    try {
      ...
      if (res.success && res.data != null) {
        ...
        Get.snackbar(
          'Error',
          res.message ?? 'Failed to load notifications',
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Colors.red.withValues(alpha: 0.8),
        );
      }
  ...
  Future<bool> approveProductClaim(int claimId) async {
    try {
      ...
      if (res.success) {
        Get.snackbar(
          'Approved',
          res.message ?? 'Claim approved and payment released',
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Colors.green.withValues(alpha: 0.8),
          colorText: Colors.white,
        );
      ...
      final errorMsg = res.message ?? 'Failed to approve claim';
      if (errorMsg.toLowerCase().contains('unauthorized') ||
          errorMsg.toLowerCase().contains('permission')) {
        Get.snackbar(
          'Permission Denied',
          'You do not have permission to approve claims. Contact admin.',
          snackPosition: SnackPosition.BOTTOM,
  ...
  Future<bool> rejectProductClaim({
    ...
    try {
      ...
      Get.snackbar(
        'Error',
        res.message ?? 'Failed to reject claim',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red.withValues(alpha: 0.8),
      );
      return false;
